...
# Set file paths:
file_path = str(Path(r'eeg-data/601/Rew_601_rest_bb_epoch.set'))  # 5 second epoched file
mat_reject = str(Path(r'eeg-data/601/Rew_601_rest_reject_rmm.mat'))  #  labeled array file
mat_stage = str(Path(r'eeg-data/601/Rew_601_rest_stages.mat'))  # sleep stages array file
